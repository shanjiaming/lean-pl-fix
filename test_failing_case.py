...
def test_failing_case():
    """Test pipeline_results.json consistency with a failing case"""
    
    # Use a problem that should fail verification
    problem_id = "putnam_1964_a1"  # This one should fail verification
    
    print(f"=== Testing failing case consistency ===")
    ...
    # Find the most recent record for our problem
    target_record = None
    ...
    if hole_consistent and filled_consistent:
        ...
        print("🔧 Fix working correctly for failing cases too")
    else:
