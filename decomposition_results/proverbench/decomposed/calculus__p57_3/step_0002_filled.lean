theorem h_main  : ∃ a b, a < b ∧ a = (21 - √497) / 4 ∧ b = (21 + √497) / 4 ∧ ∀ (x : ℝ), deriv (deriv sorry) x = 0 ↔ x = a ∨ x = b :=
  by
    ...
    · intro h
      have h₂ : (50 * x ^ 2 - 525 * x - 175 : ℝ) = 0 :=
        ...
        have h₅ : (50 * x ^ 2 - 525 * x - 175 : ℝ) = 0 :=
          ...
          have h₇ : (50 * x ^ 2 - 525 * x - 175 : ℝ) / ((5 * x ^ 2 + 35 : ℝ) ^ (5 / 2 : ℕ)) ≠ 0 := by positivity
          contradiction
        exact h₅
      have h₃ : x = (21 - Real.sqrt 497) / 4 ∨ x = (21 + Real.sqrt 497) / 4 :=
        by
        ...
        have h₅ : x = (21 - Real.sqrt 497) / 4 ∨ x = (21 + Real.sqrt 497) / 4 :=
          ...
          have h₆ : x = (21 - Real.sqrt 497) / 4 ∨ x = (21 + Real.sqrt 497) / 4 :=
            ...
            nlinarith [Real.sq_sqrt (show 0 ≤ 497 by norm_num), Real.sqrt_nonneg 497,
              sq_nonneg (x - (21 - Real.sqrt 497) / 4)]
          exact h₆
        exact h₅
      cases h₃ with
