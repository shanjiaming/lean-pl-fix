theorem solutions_satisfy_equation : ∀ x ∈ solution_set, equation x = 0:=
  by
  have h_false : False:=
    by
    have h₁ : Real.sqrt 2 = 0:=
      by
      have h₂ : equation 0 = 1:=
        by
        ...
        hole
      have h₆ : equation 0 = 2 * Real.cos (2 * (0 : ℝ) + Real.pi / 3) - Real.sqrt 2:=
        by
        have h₇ : equation 0 = 2 * Real.cos (2 * (0 : ℝ) + Real.pi / 3) - Real.sqrt 2:= by -- rw [simplified_equation]
          hole
        --  rw [h₇]
        linarith
      have h₇ : 2 * Real.cos (2 * (0 : ℝ) + Real.pi / 3) - Real.sqrt 2 = 1 - Real.sqrt 2:=
        by
        ...
        norm_num
      have h₈ : equation 0 = 1 - Real.sqrt 2:= by -- linarith
        linarith
