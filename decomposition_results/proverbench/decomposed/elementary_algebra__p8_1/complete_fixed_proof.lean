theorem given_equality_holds : LHS = RHS:=
  by
  have h₁ : Real.sqrt 65 = Real.sqrt 5 * Real.sqrt 13:=
    by
    have h₁₁ : Real.sqrt 65 = Real.sqrt (5 * 13):= by -- norm_num
      norm_num
    --  rw [h₁₁]
    have h₁₂ : Real.sqrt (5 * 13) = Real.sqrt 5 * Real.sqrt 13:=
      by
    ...
    linarith
  have h₂ : RHS = (2 * Real.sqrt 13 - 5 * (Real.sqrt 5 * Real.sqrt 13)) / 52:=
    by
    --  rw [RHS]
    --  rw [h₁] <;> ring <;> field_simp <;> ring
    hole
  have h₃ : RHS = (2 - 5 * Real.sqrt 5) * Real.sqrt 13 / 52:=
    by
    --  rw [h₂]
    ...
    --  rw [h₄] <;> ring_nf <;> field_simp <;> ring_nf
    linarith
  have h₄ : LHS = (2 - 5 * Real.sqrt 5) / (4 * Real.sqrt 13):= by -- rw [LHS] <;> ring_nf <;> field_simp <;> ring_nf
    norm_cast
  have h₅ : LHS = (2 - 5 * Real.sqrt 5) * Real.sqrt 13 / 52:=
    by
    --  rw [h₄]
    have h₅₁ : (2 - 5 * Real.sqrt 5) / (4 * Real.sqrt 13) = (2 - 5 * Real.sqrt 5) * Real.sqrt 13 / 52:=
      by
    ...
    --  rw [h₅₁] <;> ring_nf <;> field_simp <;> ring_nf
    linarith
  have h₆ : LHS = RHS:= by -- rw [h₅, h₃] <;> ring_nf <;> field_simp <;> ring_nf
    linarith
  --  rw [h₆] <;> ring_nf <;> field_simp <;> ring_nf
  linarith