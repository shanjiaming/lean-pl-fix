theorem determinant_zero_if_linearly_dependent (n : Type) (inst✝² : Fintype n) (inst✝¹ : DecidableEq n) (R : Type) (inst✝ : CommRing R) (A : Matrix n n R) (i j : n) (k : R) (h : k ≠ 0) : linearly_dependent_rows A i j k ∨ linearly_dependent_columns A i j k → A.det = 0 :=
  by
  intro h_or
  cases h_or with
  | inl h_row =>
