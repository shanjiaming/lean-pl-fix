...
: (Q - 1).det ≠ 0 → (P * Q - 1).det = 0 := by
  ...
  have h_u_ne_zero : u ≠ 0 := by
    ...
    have h₂ : u = 0 := h_u_zero
    rw [h₂] at h₁
    have h₃ : (0 : Matrix (Fin n) (Fin 1) ℝ)ᵀ * (0 : Matrix (Fin n) (Fin 1) ℝ) = (1 : Matrix (Fin 1) (Fin 1) ℝ) := by hole_12
    have h₄ : (0 : Matrix (Fin n) (Fin 1) ℝ)ᵀ * (0 : Matrix (Fin n) (Fin 1) ℝ) = (0 : Matrix (Fin 1) (Fin 1) ℝ) := by
      hole_13
    have h₅ : (0 : Matrix (Fin 1) (Fin 1) ℝ) = (1 : Matrix (Fin 1) (Fin 1) ℝ) := by hole_14
