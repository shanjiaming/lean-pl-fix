theorem putnam_1974_b6 (n : ℤ) (hn : n = 1000) (count0 count1 count2 : ℕ)
  ...
  by
  have h₀ : n = (1000 : ℤ):= by -- norm_num [hn]
    linarith
  ...
  have h₄ : (count0, count1, count2) = (((2 ^ 1000 - 1) / 3, (2 ^ 1000 - 1) / 3, 1 + (2 ^ 1000 - 1) / 3) : (ℕ × ℕ × ℕ)):=
    by
    --  rw [h₁, h₂, h₃] <;> simp [Prod.ext_iff] <;> norm_num <;>
          try {decide <;> norm_num <;> rfl
          } <;>
