theorem putnam_2020_a5
  ...
  have h₃ : ∀ (n : ℤ), n ∈ {n | a n = 2020} → n ≤ (((Nat.fib 4040) - 1 : ℤ)) := by
    ...
    have h₃₂ : n ≤ (((Nat.fib 4040) - 1 : ℤ)) := by
      ...
      have h₅ : a n = 2020 := by linarith
      rw [ha] at h₅
      have h₆ : ( (fun n : ℤ => {S : Finset ℕ | (∀ k ∈ S, k > 0) ∧ ∑ k : S, Nat.fib k = n}.ncard) n : ℕ) = 2020 := by linarith
      have h₇ : n ≥ 0 := by
        by_contra h₇
        ...
        have h₈ : ( (fun n : ℤ => {S : Finset ℕ | (∀ k ∈ S, k > 0) ∧ ∑ k : S, Nat.fib k = n}.ncard) n : ℕ) = 0 := by
          ...
          have h₁₀ : {S : Finset ℕ | (∀ k ∈ S, k > 0) ∧ ∑ k : S, Nat.fib k = n} = ∅ := by
            ...
            have h₁₅ : (∑ k : S, Nat.fib k : ℤ) = n := by linarith
            have h₁₆ : (∑ k : S, Nat.fib k : ℤ) ≥ 0 := by linarith
            linarith
          linarith
        linarith
      have h₈ : n ≤ (((Nat.fib 4040) - 1 : ℤ)) := by
