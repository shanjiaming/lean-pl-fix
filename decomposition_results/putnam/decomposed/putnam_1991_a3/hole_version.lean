...
theorem putnam_1991_a3
  ...
  have h₂ : p.degree = n := by
    have h₂₁ : (n : WithBot ℕ) = p.degree := by hole_5
    have h₂₂ : p.degree = (n : WithBot ℕ) := by hole_6
    hole_4
