...
: Cospherical S := by
  ...
  have h_vol_pos : (MeasureTheory.volume (convexHull ℝ S)).toReal > 0 := by
    ...
    have h₂ : Real.sqrt (dist (L 0) (L 1) * dist (L 1) (L 2) * dist (L 2) (L 3) * dist (L 3) (L 0)) > 0 := by
      ...
      have h₃ : 0 < dist (L 0) (L 1) := by hole_23
      have h₄ : 0 < dist (L 1) (L 2) := by hole_24
      have h₅ : 0 < dist (L 2) (L 3) := by hole_25
      have h₆ : 0 < dist (L 3) (L 0) := by hole_26
      have h₇ : 0 < dist (L 0) (L 1) * dist (L 1) (L 2) := by hole_27
      have h₈ : 0 < dist (L 1) (L 2) * dist (L 2) (L 3) := by hole_28
      have h₉ : 0 < dist (L 0) (L 1) * dist (L 1) (L 2) * dist (L 2) (L 3) := by hole_29
      have h₁₀ : 0 < dist (L 0) (L 1) * dist (L 1) (L 2) * dist (L 2) (L 3) * dist (L 3) (L 0) := by hole_30
      hole_31
    hole_32
