        ...
        have h₃ : {S : EuclideanSpace ℝ (Fin 2) | ∃ R ∈ arc P Q, R 0 = S 0 ∧ R 1 > S 1 ∧ S 1 > 0} = ∅ := by
          ...
          have h₁₅ : R 0 ^ 2 + R 1 ^ 2 = 1 := by
            ...
            have h₁₅₂ : dist 0 R = Real.sqrt ( (R 0 - 0) ^ 2 + (R 1 - 0) ^ 2 ) := by
              hole_6
            rw [h₁₅₂] at h₁₅₁
            have h₁₅₃ : Real.sqrt ( (R 0 - 0) ^ 2 + (R 1 - 0) ^ 2 ) = 1 := by hole_7
            have h₁₅₄ : (R 0 - 0) ^ 2 + (R 1 - 0) ^ 2 = 1 := by
              have h₁₅₅ : Real.sqrt ( (R 0 - 0) ^ 2 + (R 1 - 0) ^ 2 ) = 1 := h₁₅₃
              have h₁₅₆ : 0 ≤ (R 0 - 0) ^ 2 + (R 1 - 0) ^ 2 := by hole_9
              hole_8
            hole_5
          have h₁₆ : R 1 > S 1 := hR1
          have h₁₇ : S 1 > 0 := hR2
          have h₁₈ : R 0 = S 0 := hR0
          have h₁₉ : R 1 > 0 := by hole_10
          have h₂₀ : R 0 > 0 := by hole_11
          have h₂₁ : S 0 > 0 := by
            hole_12
          have h₂₂ : S 1 > 0 := by hole_13
          have h₂₃ : R 1 > S 1 := by hole_14
          have h₂₄ : R 0 = S 0 := by hole_15
          have h₂₅ : R 1 > 0 := by hole_16
          have h₂₆ : R 0 > 0 := by hole_17
          have h₂₇ : S 0 > 0 := by hole_18
          have h₂₈ : S 1 > 0 := by hole_19
          have h₂₉ : R 1 > S 1 := by hole_20
          have h₃₀ : R 0 = S 0 := by hole_21
          have h₃₁ : R 1 > 0 := by hole_22
          have h₃₂ : R 0 > 0 := by hole_23
          have h₃₃ : S 0 > 0 := by hole_24
          have h₃₄ : S 1 > 0 := by hole_25
          have h₃₅ : R 1 > S 1 := by hole_26
          have h₃₆ : R 0 = S 0 := by hole_27
        ...
        have h₄ : {S : EuclideanSpace ℝ (Fin 2) | ∃ R ∈ arc P Q, R 1 = S 1 ∧ R 0 > S 0 ∧ S 0 > 0} = ∅ := by
          ...
          have h₁₆ : R 0 ^ 2 + R 1 ^ 2 = 1 := by
            ...
            have h₁₆₂ : dist 0 R = Real.sqrt ( (R 0 - 0) ^ 2 + (R 1 - 0) ^ 2 ) := by
              hole_29
            rw [h₁₆₂] at h₁₆₁
            have h₁₆₃ : Real.sqrt ( (R 0 - 0) ^ 2 + (R 1 - 0) ^ 2 ) = 1 := by hole_30
            have h₁₆₄ : (R 0 - 0) ^ 2 + (R 1 - 0) ^ 2 = 1 := by
              have h₁₆₅ : Real.sqrt ( (R 0 - 0) ^ 2 + (R 1 - 0) ^ 2 ) = 1 := h₁₆₃
              have h₁₆₆ : 0 ≤ (R 0 - 0) ^ 2 + (R 1 - 0) ^ 2 := by hole_32
              hole_31
            nlinarith
          have h₁₇ : R 1 = S 1 := hR0
          have h₁₈ : R 0 > S 0 := hR1
