        ...
        have h₅ : ∃ i ≥ 3, a i % 100 = k := by
          ...
          · 
            have h₈ : a (max i 3) % 100 = 87 := h_a_ge_3 (max i 3) (by
              ...
              <;> omega)
            have h₉ : a i % 100 = k := h₇
            have h₁₀ : i ≥ 3 ∨ i < 3 := by hole_16
            cases' h₁₀ with h₁₀ h₁₀
            · 
              have h₁₁ : a i % 100 = 87 := h_a_ge_3 i h₁₀
              have h₁₂ : k = 87 := by hole_17
              simp_all
            · 
              have h₁₁ : i < 3 := h₁₀
              have h₁₂ : i = 0 ∨ i = 1 ∨ i = 2 := by hole_18
              ...
              · 
                ...
                have h₁₅ : a i % 100 = k := h₁₄
                have h₁₆ : i ≥ 0 := hi
                have h₁₇ : i ≥ 3 ∨ i < 3 := by hole_19
                cases' h₁₇ with h₁₇ h₁₇
                · 
                  have h₁₈ : a i % 100 = 87 := h_a_ge_3 i h₁₇
                  have h₁₉ : k = 87 := by hole_20
                  simp_all
                · 
                  have h₁₈ : i = 0 ∨ i = 1 ∨ i = 2 := by hole_21
                  rcases h₁₈ with (rfl | rfl | rfl)
                  · 
              ...
              · 
                ...
                have h₁₅ : a i % 100 = k := h₁₄
                have h₁₆ : i ≥ 1 := hi
                have h₁₇ : i ≥ 3 ∨ i < 3 := by hole_22
                cases' h₁₇ with h₁₇ h₁₇
                · 
                  have h₁₈ : a i % 100 = 87 := h_a_ge_3 i h₁₇
                  have h₁₉ : k = 87 := by hole_23
                  simp_all
                · 
                  have h₁₈ : i = 1 ∨ i = 2 := by hole_24
