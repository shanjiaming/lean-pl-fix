theorem h₅ (a : ℕ → ℕ) (ha1 : a 1 = 3) (ha : ∀ i ≥ 1, a (i + 1) = 3 ^ a i) (h_a2 : a 2 = 27) (h_a3 : a 3 % 100 = 87) (h_a_ge_3 : ∀ i ≥ 3, a i % 100 = 87) (k : Fin 100) (hk : k ∈ {k | ∀ (N : ℕ), ∃ i ≥ N, a i % 100 = ↑k}) (h₁ : ∀ (N : ℕ), ∃ i ≥ N, a i % 100 = ↑k) (h₃ : k ≠ 87) (h₄ : ∀ i ≥ 3, a i % 100 = 87) : ∃ i ≥ 3, a i % 100 = ↑k := by
  have h₆ := h₁ 3
  obtain ⟨i, hi, h₇⟩ := h₆
  refine' ⟨max i 3, _⟩
  constructor
