...
theorem putnam_2018_b6
  ...
  have h_bound : (2 : ℝ) ^ 2018 ≤ (2 : ℝ) ^ 3860 * ((2018 : ℝ) / 2048) ^ 2018 := by
    have h₁ : (2 : ℝ) ^ 2018 ≤ (2 : ℝ) ^ 3860 * ((2018 : ℝ) / 2048) ^ 2018 := by
      ...
      have h₂ : (2 : ℝ) ^ 3860 * ((2018 : ℝ) / 2048) ^ 2018 = (2 : ℝ) ^ 3860 * ((2018 : ℝ) / 2048) ^ 2018 := by hole_8
      rw [h₂]
      have h₃ : (2 : ℝ) ^ 2018 ≤ (2 : ℝ) ^ 3860 * ((2018 : ℝ) / 2048) ^ 2018 := by
        have h₄ : (2 : ℝ) ^ 3860 * ((2018 : ℝ) / 2048) ^ 2018 = (2 : ℝ) ^ 3860 * ((2018 : ℝ) / 2048) ^ 2018 := by hole_10
        rw [h₄]
        have h₅ : (2 : ℝ) ^ 3860 * ((2018 : ℝ) / 2048) ^ 2018 ≥ (2 : ℝ) ^ 2018 := by
          ...
          have h₆ : (2 : ℝ) ^ 3860 * ((2018 : ℝ) / 2048) ^ 2018 ≥ (2 : ℝ) ^ 2018 := by
            ...
            have h₇ : (2 : ℝ) ^ 3860 * ((2018 : ℝ) / 2048) ^ 2018 ≥ (2 : ℝ) ^ 2018 := by
              ...
              have h₈ : (2018 : ℝ) / 2048 > 0 := by hole_14
              have h₉ : (2 : ℝ) ^ 3860 > 0 := by hole_15
              have h₁₀ : ((2018 : ℝ) / 2048 : ℝ) ^ 2018 > 0 := by hole_16
              have h₁₁ : (2 : ℝ) ^ 3860 * ((2018 : ℝ) / 2048) ^ 2018 > 0 := by hole_17
              have h₁₂ : (2 : ℝ) ^ 3860 * ((2018 : ℝ) / 2048) ^ 2018 ≥ (2 : ℝ) ^ 2018 := by
                
                have h₁₃ : ((2018 : ℝ) / 2048 : ℝ) < 1 := by hole_19
                have h₁₄ : ((2018 : ℝ) / 2048 : ℝ) ^ 2018 > 0 := by hole_20
          ...
          have h₂₀ : (2 : ℝ) ^ 3860 * ((2018 : ℝ) / 2048) ^ 2018 ≥ (2 : ℝ) ^ 2018 := by
            ...
            have h₂₁ : (2 : ℝ) ^ 3860 * ((2018 : ℝ) / 2048) ^ 2018 ≥ (2 : ℝ) ^ 2018 := by
              ...
              have h₂₂ : (2 : ℝ) ^ 3860 * ((2018 : ℝ) / 2048) ^ 2018 ≥ (2 : ℝ) ^ 2018 := by
                ...
                have h₂₃ : ((2018 : ℝ) / 2048 : ℝ) < 1 := by hole_29
                have h₂₄ : ((2018 : ℝ) / 2048 : ℝ) ^ 2018 > 0 := by hole_30
                have h₂₅ : (2 : ℝ) ^ 3860 ≥ (2 : ℝ) ^ 2018 := by
