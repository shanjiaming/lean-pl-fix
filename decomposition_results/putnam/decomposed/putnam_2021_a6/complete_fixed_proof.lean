  ...
  have h_main : (∀ P, (∀ n : ℕ, P.coeff n = 0 ∨ P.coeff n = 1) → (∃ Q R : Polynomial ℤ, Q.degree > 0 ∧ R.degree > 0 ∧ P = Q * R) → (P.eval 2 ≠ 0 ∧ P.eval 2 ≠ 1 ∧ ¬Prime (P.eval 2))) := by
    ...
    have h₁ : P.eval 2 ≠ 0 := by
      ...
      have h₅ : (Q.eval 2 : ℤ) ≠ 0 := by
        by_contra h₅
        have h₆ : (Q.eval 2 : ℤ) = 0 := by admit
        have h₇ : (Polynomial.eval 2 (Q : Polynomial ℤ)) = 0 := by admit
      ...
      have h₆ : (R.eval 2 : ℤ) ≠ 0 := by
        by_contra h₆
        have h₇ : (R.eval 2 : ℤ) = 0 := by admit
        have h₈ : (Polynomial.eval 2 (R : Polynomial ℤ)) = 0 := by admit
    ...
    have h₂ : P.eval 2 ≠ 1 := by
      ...
      have h₆ : (Q.eval 2 : ℤ) = 1 ∨ (Q.eval 2 : ℤ) = -1 := by
        ...
        have h₈ : (Q.eval 2 : ℤ) = 1 ∨ (Q.eval 2 : ℤ) = -1 := by
          ...
          have h₉ : (Q.eval 2 : ℤ).natAbs ∣ 1 := by admit
      ...
      have h₇ : (R.eval 2 : ℤ) = 1 ∨ (R.eval 2 : ℤ) = -1 := by
        ...
        have h₉ : (R.eval 2 : ℤ) = 1 ∨ (R.eval 2 : ℤ) = -1 := by
          ...
          have h₁₀ : (R.eval 2 : ℤ).natAbs ∣ 1 := by admit
      ...
      have h₈ : False := by
        ...
        have h₁₅ : (Q.eval 2 : ℤ) ≠ 1 := by
          by_contra h₁₅
          have h₁₆ : (Q.eval 2 : ℤ) = 1 := by admit
          have h₁₇ : Polynomial.degree Q ≤ 0 := by
            by_contra h₁₇
            have h₁₈ : Polynomial.degree Q > 0 := by admit
            have h₁₉ : (Q.eval 2 : ℤ) ≠ 1 := by
        ...
        have h₁₇ : (R.eval 2 : ℤ) ≠ 1 := by
          by_contra h₁₇
          have h₁₈ : (R.eval 2 : ℤ) = 1 := by admit
          have h₁₉ : Polynomial.degree R ≤ 0 := by
            by_contra h₁₉
            have h₂₀ : Polynomial.degree R > 0 := by admit
            have h₂₁ : (R.eval 2 : ℤ) ≠ 1 := by
