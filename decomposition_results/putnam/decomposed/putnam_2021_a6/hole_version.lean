  ...
  have h_main : (∀ P, (∀ n : ℕ, P.coeff n = 0 ∨ P.coeff n = 1) → (∃ Q R : Polynomial ℤ, Q.degree > 0 ∧ R.degree > 0 ∧ P = Q * R) → (P.eval 2 ≠ 0 ∧ P.eval 2 ≠ 1 ∧ ¬Prime (P.eval 2))) := by
    ...
    have h₁ : P.eval 2 ≠ 0 := by
      ...
      have h₅ : (Q.eval 2 : ℤ) ≠ 0 := by
        by_contra h₅
        have h₆ : (Q.eval 2 : ℤ) = 0 := by hole_7
        have h₇ : (Polynomial.eval 2 (Q : Polynomial ℤ)) = 0 := by hole_8
      ...
      have h₆ : (R.eval 2 : ℤ) ≠ 0 := by
        by_contra h₆
        have h₇ : (R.eval 2 : ℤ) = 0 := by hole_11
        have h₈ : (Polynomial.eval 2 (R : Polynomial ℤ)) = 0 := by hole_12
    ...
    have h₂ : P.eval 2 ≠ 1 := by
      ...
      have h₆ : (Q.eval 2 : ℤ) = 1 ∨ (Q.eval 2 : ℤ) = -1 := by
        ...
        have h₈ : (Q.eval 2 : ℤ) = 1 ∨ (Q.eval 2 : ℤ) = -1 := by
          ...
          have h₉ : (Q.eval 2 : ℤ).natAbs ∣ 1 := by hole_21
      ...
      have h₇ : (R.eval 2 : ℤ) = 1 ∨ (R.eval 2 : ℤ) = -1 := by
        ...
        have h₉ : (R.eval 2 : ℤ) = 1 ∨ (R.eval 2 : ℤ) = -1 := by
          ...
          have h₁₀ : (R.eval 2 : ℤ).natAbs ∣ 1 := by hole_29
      ...
      have h₈ : False := by
        ...
        have h₁₅ : (Q.eval 2 : ℤ) ≠ 1 := by
          by_contra h₁₅
          have h₁₆ : (Q.eval 2 : ℤ) = 1 := by hole_36
          have h₁₇ : Polynomial.degree Q ≤ 0 := by
            by_contra h₁₇
            have h₁₈ : Polynomial.degree Q > 0 := by hole_38
            have h₁₉ : (Q.eval 2 : ℤ) ≠ 1 := by
        ...
        have h₁₆ : (Q.eval 2 : ℤ) ≠ -1 := by
          by_contra h₁₆
          have h₁₇ : (Q.eval 2 : ℤ) = -1 := by hole_44
          have h₁₈ : Polynomial.degree Q ≤ 0 := by
            by_contra h₁₈
            have h₁₉ : Polynomial.degree Q > 0 := by hole_46
            have h₂₀ : (Q.eval 2 : ℤ) ≠ -1 := by
              
              have h₂₁ : Polynomial.degree Q > 0 := h₁₉
              have h₂₂ : (Q.eval 2 : ℤ) ≠ -1 := by
                by_contra h₂₂
                have h₂₃ : (Q.eval 2 : ℤ) = -1 := by hole_49
                have h₂₄ : Polynomial.degree Q ≤ 0 := by
                  hole_50
                hole_48
              hole_47
        ...
        have h₁₇ : (R.eval 2 : ℤ) ≠ 1 := by
          by_contra h₁₇
          have h₁₈ : (R.eval 2 : ℤ) = 1 := by hole_52
          have h₁₉ : Polynomial.degree R ≤ 0 := by
            by_contra h₁₉
            have h₂₀ : Polynomial.degree R > 0 := by hole_54
            have h₂₁ : (R.eval 2 : ℤ) ≠ 1 := by
        ...
        have h₁₈ : (R.eval 2 : ℤ) ≠ -1 := by
          by_contra h₁₈
          have h₁₉ : (R.eval 2 : ℤ) = -1 := by hole_60
          have h₂₀ : Polynomial.degree R ≤ 0 := by
            by_contra h₂₀
            have h₂₁ : Polynomial.degree R > 0 := by hole_62
            have h₂₂ : (R.eval 2 : ℤ) ≠ -1 := by
              
              have h₂₃ : Polynomial.degree R > 0 := h₂₁
              have h₂₄ : (R.eval 2 : ℤ) ≠ -1 := by
                by_contra h₂₄
                have h₂₅ : (R.eval 2 : ℤ) = -1 := by hole_65
                have h₂₆ : Polynomial.degree R ≤ 0 := by
                  hole_66
                hole_64
              hole_63
    ...
    have h₃ : ¬Prime (P.eval 2) := by
      ...
      have h₁₁ : False := by
        ...
        have h₁₆ : (Q.eval 2 : ℤ) ≠ 1 := by
          by_contra h₁₆
          have h₁₇ : (Q.eval 2 : ℤ) = 1 := by hole_73
          have h₁₈ : Polynomial.degree Q ≤ 0 := by
            by_contra h₁₈
            have h₁₉ : Polynomial.degree Q > 0 := by hole_75
            have h₂₀ : (Q.eval 2 : ℤ) ≠ 1 := by
        ...
        have h₁₇ : (Q.eval 2 : ℤ) ≠ -1 := by
          by_contra h₁₇
          have h₁₈ : (Q.eval 2 : ℤ) = -1 := by hole_81
          have h₁₉ : Polynomial.degree Q ≤ 0 := by
            by_contra h₁₉
            have h₂₀ : Polynomial.degree Q > 0 := by hole_83
            have h₂₁ : (Q.eval 2 : ℤ) ≠ -1 := by
              
              have h₂₂ : Polynomial.degree Q > 0 := h₂₀
              have h₂₃ : (Q.eval 2 : ℤ) ≠ -1 := by
                by_contra h₂₃
                have h₂₄ : (Q.eval 2 : ℤ) = -1 := by hole_86
                have h₂₅ : Polynomial.degree Q ≤ 0 := by
                  hole_87
                hole_85
              hole_84
        ...
        have h₁₈ : (R.eval 2 : ℤ) ≠ 1 := by
          by_contra h₁₈
          have h₁₉ : (R.eval 2 : ℤ) = 1 := by hole_89
          have h₂₀ : Polynomial.degree R ≤ 0 := by
            by_contra h₂₀
            have h₂₁ : Polynomial.degree R > 0 := by hole_91
            have h₂₂ : (R.eval 2 : ℤ) ≠ 1 := by
        ...
        have h₁₉ : (R.eval 2 : ℤ) ≠ -1 := by
          by_contra h₁₉
          have h₂₀ : (R.eval 2 : ℤ) = -1 := by hole_97
          have h₂₁ : Polynomial.degree R ≤ 0 := by
            by_contra h₂₁
            have h₂₂ : Polynomial.degree R > 0 := by hole_99
            have h₂₃ : (R.eval 2 : ℤ) ≠ -1 := by
              
              have h₂₄ : Polynomial.degree R > 0 := h₂₂
              have h₂₅ : (R.eval 2 : ℤ) ≠ -1 := by
                by_contra h₂₅
                have h₂₆ : (R.eval 2 : ℤ) = -1 := by hole_102
                have h₂₇ : Polynomial.degree R ≤ 0 := by
                  hole_103
                hole_101
              hole_100
