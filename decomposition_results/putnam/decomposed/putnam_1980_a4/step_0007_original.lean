theorem h_main₂ (abcvals : ℤ → ℤ → ℤ → Prop) (habcvals : ∀ (a b c : ℤ), abcvals a b c ↔ (a = 0 ∧ b = 0 ∧ c = 0) ∧ |a| < 1000000 ∧ |b| < 1000000 ∧ |c| < 1000000) (h_main₁ : ∃ a b c, abcvals a b c ∧ |↑a + ↑b * √2 + ↑c * √3| < 10 ^ (-11)) : False := by
