    ...
    · 
      ...
      have h₁ : g x = 2 * x := by
        ...
        have h₇ : g x = 2 * x := by
          ...
          have h₁₃ : 6 * x - g x > 0 := by
            by_contra h₁₄
            have h₁₅ : 6 * x - g x ≤ 0 := by hole_12
            have h₁₆ : g (6 * x - g x) > 0 := (hg (6 * x - g x) (by linarith)).2
            have h₁₇ : g (6 * x - g x) = 7 * g x - 6 * x := h₆
            have h₁₈ : 7 * g x - 6 * x > 0 := by hole_13
            have h₁₉ : 6 * x - g x ≤ 0 := by hole_14
            hole_11
          have h₂₀ : g (6 * x - g x) > 0 := (hg (6 * x - g x) h₁₃).2
          have h₂₁ : g (6 * x - g x) = 7 * g x - 6 * x := h₆
          have h₂₂ : 7 * g x - 6 * x > 0 := by hole_15
          ...
          have h₂₆ : g (7 * g x - 6 * x) = 3 * (6 * x - g x) := by hole_18
          have h₂₇ : g (7 * g x - 6 * x) > 0 := h₂₄
          have h₂₈ : 3 * (6 * x - g x) > 0 := by hole_19
          have h₂₉ : 6 * x - g x > 0 := by hole_20
          have h₃₀ : g (6 * x - g x) = 7 * g x - 6 * x := h₆
          have h₃₁ : g (7 * g x - 6 * x) = 6 * (6 * x - g x) - g (7 * g x - 6 * x) := h₂₃
          have h₃₂ : g (7 * g x - 6 * x) = 3 * (6 * x - g x) := by hole_21
          have h₃₃ : g (6 * x - g x) = 7 * g x - 6 * x := h₆
          have h₃₄ : g x > 0 := h₁₁
          have h₃₅ : g (g x) > 0 := h₁₂
          have h₃₆ : 6 * x - g x > 0 := h₂₉
