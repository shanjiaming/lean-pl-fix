...
def check_verification_consistency(records: List[Dict], dataset_name: str) -> Tuple[List[str], List[str], List[str], List[str], Dict[str, int]]:
    """
    Check verification consistency rules for pure decomposition pipeline:
    1. original_verification_pass=True → hole_verification_pass=True
    2. [SKIP - filled_verification_pass not generated by pure decomposition]
    3. hole_verification_pass=True → clear_verification_pass=True (clear and hole must be identical)
    4. [SKIP for decompose pipeline - synthesized handled by minimal_verification_pipeline]
    ...
    for i, record in enumerate(records):
        ...
        # Rule 2: SKIP - filled_verification_pass not generated by pure decomposition
        # (This is now handled by minimal_verification_pipeline)
        ...
        # Rule 4: SKIP for decompose pipeline - synthesized handled by minimal_verification_pipeline
        # (This will be checked in minimal_verification_pipeline results)
